...
Thread Thread_I2C(osPriorityNormal, 2048);  // thread used in multithread tests
Thread Thread_SPI(osPriorityNormal, 3192);  // thread used in multithread tests
Thread Thread_GPIO(osPriorityNormal, 1024); // thread used in multithread tests
